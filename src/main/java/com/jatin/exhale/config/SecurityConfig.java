package com.jatin.exhale.config;

import com.jatin.exhale.JwtUtil;
import com.jatin.exhale.repository.UserRepo;
import com.jatin.exhale.security.CustomAuthenticationEntryPoint;
import com.jatin.exhale.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,JwtAuthenticationFilter jwtAuthenticationFilter, CustomAuthenticationEntryPoint customAuthenticationEntryPoint) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/login","/api/auth/register","/api/auth/google").permitAll().requestMatchers(HttpMethod.GET,"/api/posts", "/api/posts/**","/api/comments/post/{postId}").permitAll()
